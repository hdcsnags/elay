...
6. Before you stop: `STATE.md` newest-first entry, commit + push (repo is public: `hdcsnags/elay`), `supabase stop` if you started it, update `ELAY-CONCIERGE.md` and the skills if anything stopped being true.
