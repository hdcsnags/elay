...
select throws_ok(
    $$insert into public.goals (owner_id, title, pair_id, visibility)
...
select throws_ok(
    ...
    '23514',
    'new row for relation "goals" violates check constraint "goals_visibility_pair_check"',
...
select throws_ok(
    ...
    '23514',
    'new row for relation "goals" violates check constraint "goals_visibility_check"',
